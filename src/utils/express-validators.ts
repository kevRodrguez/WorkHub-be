    ...
    static crearPerfilEmpresa(): ValidationChain[] {
        return [
            ...
            body('fecha_nacimiento_fundacion')
                .optional()
                .isISO8601()
                .withMessage('La fecha de fundación debe tener un formato válido (YYYY-MM-DD)')
                .custom((value) => {
    ...
    static crearCategoria(): ValidationChain[] {
        return [
            body('nombre_categoria')
                ...
                .isLength({ min: 2, max: 100 })
                .withMessage('El nombre de la categoría debe tener entre 2 y 100 caracteres')
                .trim(),
    ...
    static crearPerfilCandidato(): ValidationChain[] {
        return [
            ...
            body('genero')
                ...
                .withMessage('El género debe ser uno de: masculino, femenino, otro, prefiero no decir'),

            body('estado_civil')
                .notEmpty()
                .withMessage('El estado civil es requerido')
                .isIn(['soltero', 'casado', 'divorciado', 'viudo', 'unión libre'])
                .withMessage('El estado civil debe ser uno de: soltero, casado, divorciado, viudo, unión libre'),
