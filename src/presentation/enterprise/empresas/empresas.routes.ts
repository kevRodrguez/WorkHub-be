...
import { getEmpresasValidator, seguirDejarDeSeguirEmpresaValidator } from "../../../middlewares/validators/enterprise/empresas.validator";
...
export class EmpresasEnterpriseRoutes {
  static get routes(): Router {
    ...
    router.post('/seguir/', runValidations(seguirDejarDeSeguirEmpresaValidator), EmpresasEnterpriseController.seguirEmpresa);
    router.post('/dejar-seguir/', runValidations(seguirDejarDeSeguirEmpresaValidator), EmpresasEnterpriseController.dejarDeSeguirEmpresa);
    return router;
  }
}
