...
import { getAplicacionesByTrabajoIdValidator, updateEstadoAplicacionValidator } from "../../../middlewares/validators/aplicaiones.validator";
...
export class AplicacionesEnterpriseRoutes {
  static get routes(): Router {
    ...
    router.put('/:id_aplicacion', runValidations(updateEstadoAplicacionValidator), AplicacionesEnterpriseController.updateEstadoAplicacion)
